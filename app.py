...
if not st.session_state.token:
    ...
    pass
    st.write("Login/Register UI Placeholder") # Placeholder
    ...
    # ==============================================================================
    # --- FLOATING CHAT WIDGET LOGIC (The Definitive Version) ---
    # ==============================================================================

    # This is the function that will run inside the popup dialog
    ...
    # This CSS makes the button float in the bottom-right corner
    st.markdown("""
        <style>
